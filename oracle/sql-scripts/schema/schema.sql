...
--
-- This script uses features of the Oracle Database version 23ai
----------------------------------------------------------------
...
COMMENT ON COLUMN address.objectid IS '...';
/* Add comments for the table and all columns in the table */
...
CREATE TABLE IF NOT EXISTS feature (
  ...
  creation_date                 TIMESTAMP WITH TIME ZONE,   -- Date when inserted into the CityGML data
  termination_date              TIMESTAMP WITH TIME ZONE,   -- Date when set in CityGML data
  valid_from                    TIMESTAMP WITH TIME ZONE,
  valid_to                      TIMESTAMP WITH TIME ZONE,
  CONSTRAINT feature_pk PRIMARY KEY ( id ) ENABLE
);

ALTER TABLE feature ADD PERIOD FOR valid_time (valid_from, valid_to);  -- Add temporal validity
